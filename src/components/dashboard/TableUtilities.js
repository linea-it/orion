...
export default class TableUtilities extends Component {
    constructor() {
        ...
        let columnsTableUtilities = columnsTableDashboard;
        ...
        for(let col of columnsTableUtilities) {
            this.colOptionsTableUtilities.push({label: col.header, value: col});
        }

        this.onColumnToggleTableUtilities = this.onColumnToggleTableUtilities.bind(this);
    }
    ...
    render() {
        let footer = <div style={{textAlign:'left'}}>
                        <MultiSelect value={this.state.colsTableUtilities} options={this.colOptionsTableUtilities} onChange={this.onColumnToggleTableUtilities} />
                    </div>;

        let columnsTableUtilities = this.state.colsTableUtilities.map((col,i) => {
